      ...
      >
        <Stack textAlign="center" align="center" gap="6">
          <Stack w="100%" maxW="872px">
            <LandingH>
              MasterGiver Makes Your Community Impact Visible
            </LandingH>
          </Stack>
          <Text color="text.primary" maxW="1032px">
            ...
            — into verified reputation signals AI and search engines can read and
            trust. So your business doesn&apos;t just do good, but turns trust
