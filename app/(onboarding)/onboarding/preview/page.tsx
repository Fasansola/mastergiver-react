...
async function getProfilePreviewData(userId: string) {
  const [user, causes, skills] = await Promise.all([
    ...
    // All predefined causes for the edit dropdown — individual panel only
    ...
    <VStack gap="6" alignItems="flex-start">
      <VStack alignItems="flex-start">
        <Heading fontSize="heading" fontWeight="700">
          Review and Launch Your Profile
        </Heading>
        <Text maxW="700px" fontSize="md">
          Take a moment to double-check your details. Once you’re ready, hit
          submit and share your profile with the world!
        </Text>
      </VStack>
      <ProfilePreview
        mode="onboarding"
